...
_$DanceRoutineImpl _$$DanceRoutineImplFromJson(Map<String, dynamic> json) =>
    _$DanceRoutineImpl(
      ...
      status:
          $enumDecodeNullable(_$RoutineStatusEnumMap, json['status']) ??
          RoutineStatus.new_,
...
Map<String, dynamic> _$$DanceRoutineImplToJson(_$DanceRoutineImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
...
const _$RoutineStatusEnumMap = {
  RoutineStatus.new_: 'new',
  RoutineStatus.learning: 'learning',
  RoutineStatus.reviewing: 'reviewing',
};
