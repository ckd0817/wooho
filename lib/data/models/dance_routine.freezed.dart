...
DanceRoutine _$DanceRoutineFromJson(Map<String, dynamic> json) {
  return _DanceRoutine.fromJson(json);
}

/// @nodoc
mixin _$DanceRoutine {
  ...
  int? get updatedAt => throw _privateConstructorUsedError; // Timestamp
  // 可选：备注
  String? get notes => throw _privateConstructorUsedError;

  /// Serializes this DanceRoutine to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of DanceRoutine
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $DanceRoutineCopyWith<DanceRoutine> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DanceRoutineCopyWith<$Res> {
  factory $DanceRoutineCopyWith(
    DanceRoutine value,
    $Res Function(DanceRoutine) then,
  ) = _$DanceRoutineCopyWithImpl<$Res, DanceRoutine>;
  @useResult
  $Res call({
    String id,
    String name,
...
/// @nodoc
class _$DanceRoutineCopyWithImpl<$Res, $Val extends DanceRoutine>
    implements $DanceRoutineCopyWith<$Res> {
  _$DanceRoutineCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$DanceRoutineImplCopyWith<$Res>
    implements $DanceRoutineCopyWith<$Res> {
  factory _$$DanceRoutineImplCopyWith(
    _$DanceRoutineImpl value,
    $Res Function(_$DanceRoutineImpl) then,
  ) = __$$DanceRoutineImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({
    String id,
...
/// @nodoc
class __$$DanceRoutineImplCopyWithImpl<$Res>
    extends _$DanceRoutineCopyWithImpl<$Res, _$DanceRoutineImpl>
    implements _$$DanceRoutineImplCopyWith<$Res> {
  __$$DanceRoutineImplCopyWithImpl(
    _$DanceRoutineImpl _value,
    $Res Function(_$DanceRoutineImpl) _then,
  ) : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$DanceRoutineImpl implements _DanceRoutine {
  const _$DanceRoutineImpl({
    required this.id,
    required this.name,
    ...
    this.status = RoutineStatus.new_,
  ...
  factory _$DanceRoutineImpl.fromJson(Map<String, dynamic> json) =>
      _$$DanceRoutineImplFromJson(json);
  ...
  @override
  String toString() {
    return 'DanceRoutine(id: $id, name: $name, category: $category, videoSourceType: $videoSourceType, videoUri: $videoUri, trimStart: $trimStart, trimEnd: $trimEnd, status: $status, masteryLevel: $masteryLevel, lastPracticedAt: $lastPracticedAt, createdAt: $createdAt, updatedAt: $updatedAt, notes: $notes)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$DanceRoutineImplCopyWith<_$DanceRoutineImpl> get copyWith =>
      __$$DanceRoutineImplCopyWithImpl<_$DanceRoutineImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$DanceRoutineImplToJson(this);
  }
}

abstract class _DanceRoutine implements DanceRoutine {
  const factory _DanceRoutine({
  ...
  factory _DanceRoutine.fromJson(Map<String, dynamic> json) =
      _$DanceRoutineImpl.fromJson;
